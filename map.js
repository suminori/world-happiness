...
Promise.all(promises).then(function(data) {
    ...
    const bot10 = ["India", "Yemen", "Botswana", "Tanzania", "Central African Rep.", "Rwanda", "Zimbabwe", "S. Sudan", "Afghanistan"]
    ...
    countries = countriesGroup
        ...
        /*else if (bot10.indexOf(d.properties.name) >= 0){
            return "bot10";
        }*/
    ...
    countries.on("mouseover", function(e, d) {
            ...
            tooltip.style("visibility", "visible")
                .style("left", cx + "px") 
                .style("top", cy + "px")  
                .html(`<b>${d.properties.name}</b><br>Happiness Rank: ${d.properties.rank}<br>Population: ${format(d.properties.pop_est)}`);
